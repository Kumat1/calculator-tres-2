...
class Calculator {
    ...
    public void calc()
    {
        ...
        frame1.setBounds(300,200,250,400);

        frame1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame1.setLayout(null);

        final JTextField txtid = new JTextField();
        txtid.setBounds(10,10,200,55);
        frame1.add(txtid);
        txtid.setFont(new java.awt.Font("Comic sans ms", 0, 22));
        ...
        m.setBounds(160,170,50,50);
        frame1.add(m);

        JButton n = new JButton ("/");
        n.setBounds(160,220,50,50);
        frame1.add(n);

        JButton o = new JButton ("=");
        o.setBounds(110,270,100,50);
        frame1.add(o);

        JButton p = new JButton (".");
        p.setBounds(10,270,50,50);
        frame1.add(p);

        JButton q = new JButton ("<");
        q.setBounds(60,70,50,50);
        frame1.add(q);

        JButton s = new JButton ("%");
        s.setBounds(110,70,50,50);
        frame1.add(s);

        JButton r = new JButton ("C");
